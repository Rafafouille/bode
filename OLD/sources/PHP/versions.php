				...
				<h3 onclick="$('#precedentes_modifs').toggle('fast');" style="cursor:pointer;">Précédentes modifications</h3>
				...
				<h3 onclick="$('#Liste_a_faire').toggle('fast');" style="cursor:pointer;">À Faire...</h3>

					<div id="Liste_a_faire" style="display:none;overflow:hidden;">
						<ul>
